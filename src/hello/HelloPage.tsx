  ...
  return <div className="hello-page">
    ...
    <main id="hello-content">
      ...
      <section className="hello-proof" id="evidencia" aria-labelledby="hello-proof-title">
        ...
        <div className="hello-proof-list"><a href={routes.eunomiLanding}><span>01 / Coordinación de transporte escolar</span><strong>Eunomi Escolar</strong><p>Rutas, asistencia y seguimiento organizados para administración, conductores y familias.</p><i aria-hidden="true">Conocer Eunomi →</i></a><a href={routes.gcms}><span>02 / Operación de gaming centers</span><strong>GCMS</strong><p>Estaciones, clientes y sesiones reunidos en un sistema con reglas de negocio comprobadas.</p><i aria-hidden="true">Ver caso →</i></a></div>
      </section>
