  ...
  return <div className="products-page">
    ...
    <main id="products-content">
      ...
      <article className="product-feature product-feature--eunomi" id="eunomi">
        <div className="product-feature-copy"><div className="product-feature-meta"><span>01 / Transporte escolar</span><Status>Prioridad actual</Status></div><p className="product-feature-name">Eunomi Escolar</p><h2>Organizar recorridos y mantener informadas a las familias.</h2><p className="product-feature-lead">Eunomi busca reunir rutas, asistencia y avisos de recogida y entrega para acompañar el servicio de transporte escolar.</p><dl><div><dt>Para quién</dt><dd>Transportistas escolares; conductores y apoderados participan por invitación.</dd></div><div><dt>Qué existe hoy</dt><dd>Base funcional por roles, aplicación móvil, panel administrativo, backend y una landing comercial con consulta directa.</dd></div><div><dt>Qué continúa</dt><dd>Modernización del producto, aislamiento por organización y validación con operadores reales.</dd></div></dl><div className="product-feature-actions"><a href={routes.eunomiLanding}>Conocer Eunomi <span aria-hidden="true">→</span></a><a href={routes.eunomi}>Ver caso de estudio</a></div></div>
