...
function ProductsHeader() {
  return <header className="products-page-header"><a className="products-brand" href="/" aria-label="Volver al inicio"><span aria-hidden="true">IB</span><strong>Iván Bozo Catalán</strong></a><nav aria-label="Navegación de productos"><a href="#eunomi">Eunomi</a><a href="#gcms-product">GCMS</a><a href="#producto-o-servicio">Producto o servicio</a></nav><a className="products-back" href="/">← Portfolio</a></header>;
}
  ...
  return <div className="products-page">
    ...
    <main id="products-content">
      ...
      <article className="product-feature product-feature--eunomi" id="eunomi">
        <div className="product-feature-copy"><div className="product-feature-meta"><span>01 / Transporte escolar</span><Status>En desarrollo</Status></div><p className="product-feature-name">Eunomi Escolar</p><h2>Organizar recorridos y mantener informadas a las familias.</h2><p className="product-feature-lead">Eunomi busca reunir rutas, asistencia y avisos de recogida y entrega para acompañar el servicio de transporte escolar.</p><dl><div><dt>Para quién</dt><dd>Transportistas escolares; conductores y apoderados participan por invitación.</dd></div><div><dt>Qué existe hoy</dt><dd>Base funcional por roles, aplicación móvil, panel administrativo, backend y una demo preservada.</dd></div><div><dt>Qué continúa</dt><dd>Modernización, validación comercial e integración definitiva de su landing al dominio.</dd></div></dl><div className="product-feature-actions"><a href="?project=school-transport">Ver caso de estudio <span aria-hidden="true">→</span></a><a href="mailto:iv.bozo.catalan@gmail.com?subject=Me%20interesa%20Eunomi%20Escolar">Consultar por Eunomi</a></div></div>
      ...
      <section className="product-or-service" id="producto-o-servicio" aria-labelledby="product-or-service-title"><div><p>Una diferencia útil</p><h2 id="product-or-service-title">¿Necesitas uno de estos productos o una solución para tu propio problema?</h2></div><div className="choice-grid"><article><span>Producto</span><h3>Una necesidad compartida</h3><p>Un producto se construye para un problema y un público definidos. Su evolución considera necesidades comunes de varios usuarios.</p><a href="#eunomi">Revisar productos ↑</a></article><article><span>Servicio</span><h3>Tu contexto particular</h3><p>Un servicio comienza revisando cómo trabajas tú y qué solución necesita tu operación, negocio o idea.</p><a href="?page=services">Conocer servicios →</a></article></div></section>

      <section className="products-contact"><p>¿Te interesa seguir un producto?</p><h2>Podemos conversar sobre el problema que quieres resolver.</h2><p>Las consultas no implican disponibilidad inmediata ni una contratación. Sirven para conocer el contexto y evaluar si existe un siguiente paso razonable.</p><a href="mailto:iv.bozo.catalan@gmail.com">Escribir a Iván <span aria-hidden="true">→</span></a></section>
    </main>
