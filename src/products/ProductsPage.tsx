...
export default function ProductsPage() {
  return <div className="products-page">
    ...
    <main id="products-content">
      ...
      <section className="products-contact"><p>¿Te interesa seguir un producto?</p><h2>Podemos conversar sobre el problema que quieres resolver.</h2><p>Las consultas no implican disponibilidad inmediata ni una contratación. Sirven para conocer el contexto y evaluar si existe un siguiente paso razonable.</p><a href="?page=contact">Preparar una consulta <span aria-hidden="true">→</span></a></section>
    </main>
